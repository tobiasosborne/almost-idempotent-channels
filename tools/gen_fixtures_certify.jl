...
# design doc docs/cbnorm_tight_certifier.md). Emits tests/fixtures_certify.inc.h
...
function emit(io, solved::Vector{Solved})
    ...
    println(io, " * docs/cbnorm_tight_certifier.md). For each channel: Kraus ops, eta_ref,")
